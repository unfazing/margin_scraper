...
* This application was created by Kok Hai, Software Intern at Phillip Nova, in tandem with Xiao Tian, Operations and Settlements Department.

--------------------------------------------------------------------------------------------------------------------

## **Setting up, getting started**
These instructions are for a future developer to iterate on the code.

For Windows:
1. Download the latest version of Python 3 for Windows [here](https://www.python.org/downloads/).
